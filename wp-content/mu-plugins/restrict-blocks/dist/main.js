...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nfunction _typeof(o) { \"@babel/helpers - typeof\"; return _typeof = \"function\" == typeof Symbol && \"symbol\" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && \"function\" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? \"symbol\" : typeof o; }, _typeof(o); }\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, \"prototype\", { writable: false }); return Constructor; }\nfunction _defineProperty(obj, key, value) { key = _toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }\nfunction _toPropertyKey(t) { var i = _toPrimitive(t, \"string\"); return \"symbol\" == _typeof(i) ? i : i + \"\"; }\nfunction _toPrimitive(t, r) { if (\"object\" != _typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || \"default\"); if (\"object\" != _typeof(i)) return i; throw new TypeError(\"@@toPrimitive must return a primitive value.\"); } return (\"string\" === r ? String : Number)(t); }\nvar data = window.wp.data;\nvar select = data.select,\n  dispatch = data.dispatch,\n  subscribe = data.subscribe;\nvar _select = select('core/editor'),\n  getEditedPostAttribute = _select.getEditedPostAttribute;\nvar _select2 = select('core/block-editor'),\n  isTyping = _select2.isTyping;\nvar _select3 = select('core/blocks'),\n  getBlockType = _select3.getBlockType;\nvar _dispatch = dispatch('core/blocks'),\n  addBlockTypes = _dispatch.addBlockTypes,\n  removeBlockTypes = _dispatch.removeBlockTypes;\nvar BlockRestrictor = /*#__PURE__*/function () {\n  function BlockRestrictor(blockTemplateRestrictions) {\n    _classCallCheck(this, BlockRestrictor);\n    /**\n     * Currently selected template.\n     * @type {string}\n     */\n    _defineProperty(this, \"currentTemplate\", '');\n    /**\n     * Map block names to the actual block object.\n     *\n     * @type {object}\n     */\n    _defineProperty(this, \"unregisteredBlocks\", {});\n    this.blockTemplateRestrictions = blockTemplateRestrictions;\n  }\n\n  /**\n   * Initiates listening to the redux store for when a restricted block is either\n   * added or removed.\n   */\n  return _createClass(BlockRestrictor, [{\n    key: \"run\",\n    value: function run() {\n      var _this = this;\n      this.currentTemplate = getEditedPostAttribute('template') || 'default';\n\n      /**\n       * subscribe fires whenever the redux store in gutenberg updates\n       */\n      subscribe(function () {\n        /**\n         * ensure we don't run our logic when the user is typing.\n         */\n        if (isTyping() === true) {\n          return false;\n        }\n        var newTemplate = getEditedPostAttribute('template') || 'default';\n        if (_this.currentTemplate !== newTemplate) {\n          _this.currentTemplate = newTemplate;\n          _this.restrictBlocksToTemplate();\n        }\n      });\n      window.addEventListener('load', function () {\n        _this.restrictBlocksToTemplate();\n      });\n    }\n\n    /**\n     * Helps decide which blocks we actually want to add or remove from\n     * the store.\n     */\n  }, {\n    key: \"templateBlockRegistry\",\n    value: function templateBlockRegistry() {\n      var _this2 = this;\n      var blocksToAdd = [];\n      var blocksToRemove = [];\n      Object.keys(this.blockTemplateRestrictions).forEach(function (blockName) {\n        if (_this2.blockTemplateRestrictions[blockName].includes(_this2.currentTemplate)) {\n          blocksToAdd.push(blockName);\n        } else {\n          blocksToRemove.push(blockName);\n        }\n      });\n      return {\n        blocksToAdd: blocksToAdd,\n        blocksToRemove: blocksToRemove\n      };\n    }\n\n    /**\n     * Either removes or adds blocks to the store based on what the current\n     * template is.\n     */\n  }, {\n    key: \"restrictBlocksToTemplate\",\n    value: function restrictBlocksToTemplate() {\n      var _this3 = this;\n      var _this$templateBlockRe = this.templateBlockRegistry(),\n        blocksToAdd = _this$templateBlockRe.blocksToAdd,\n        blocksToRemove = _this$templateBlockRe.blocksToRemove;\n      if (blocksToRemove.length) {\n        blocksToRemove.forEach(function (blockName) {\n          var blockExists = getBlockType(blockName);\n          var isRegistered = typeof _this3.unregisteredBlocks[blockName] === 'undefined';\n          if (blockExists && isRegistered) {\n            _this3.unregisteredBlocks[blockName] = getBlockType(blockName);\n          }\n        });\n        removeBlockTypes(Object.keys(this.unregisteredBlocks));\n      }\n      if (blocksToAdd.length) {\n        var registeredBlocks = [];\n        blocksToAdd.forEach(function (blockName) {\n          var blockExists = typeof getBlockType(blockName) === 'undefined';\n          var isUnregistered = typeof _this3.unregisteredBlocks[blockName] !== 'undefined';\n          if (blockExists && isUnregistered) {\n            registeredBlocks.push(_this3.unregisteredBlocks[blockName]);\n            delete _this3.unregisteredBlocks[blockName];\n          }\n        });\n        addBlockTypes(registeredBlocks);\n      }\n    }\n  }]);\n}();\n/* harmony default export */ __webpack_exports__[\"default\"] = (BlockRestrictor);\n\n//# sourceURL=webpack:///./js/BlockRestrictor.js?");

/***/ }),

/***/ "./js/TemplateWhitelister.js":
/*!***********************************!*\
  !*** ./js/TemplateWhitelister.js ***!
  \***********************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _BlockRestrictor__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./BlockRestrictor */ \"./js/BlockRestrictor.js\");\n/* harmony import */ var _TemplateWhitelister__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./TemplateWhitelister */ \"./js/TemplateWhitelister.js\");\nfunction _typeof(o) { \"@babel/helpers - typeof\"; return _typeof = \"function\" == typeof Symbol && \"symbol\" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && \"function\" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? \"symbol\" : typeof o; }, _typeof(o); }\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, \"prototype\", { writable: false }); return Constructor; }\nfunction _toPropertyKey(t) { var i = _toPrimitive(t, \"string\"); return \"symbol\" == _typeof(i) ? i : i + \"\"; }\nfunction _toPrimitive(t, r) { if (\"object\" != _typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || \"default\"); if (\"object\" != _typeof(i)) return i; throw new TypeError(\"@@toPrimitive must return a primitive value.\"); } return (\"string\" === r ? String : Number)(t); }\n\n\n\n/*\n * Add a mapping of block names and what templates they are\n * restricted to.\n */\nvar blockTemplateRestrictions = {\n  'acf/intro': ['default', 'template-landing-page.php'],\n  'acf/accordion': ['default', 'template-landing-page.php', 'template-homepage.php', '404.php'],\n  'acf/image': ['default', 'template-landing-page.php', 'template-homepage.php', '404.php'],\n  'acf/gallery': ['default', 'template-landing-page.php', 'template-homepage.php', '404.php'],\n  'acf/downloads': ['default', 'template-landing-page.php', 'template-homepage.php', '404.php'],\n  'acf/embed': ['default', 'template-landing-page.php', 'template-homepage.php', '404.php'],\n  'acf/testimonial': ['default', 'template-landing-page.php', 'template-homepage.php', '404.php'],\n  'acf/linkedlogos': ['default', 'template-landing-page.php', 'template-homepage.php', '404.php'],\n  'acf/cta': ['default', 'template-landing-page.php', 'template-homepage.php', '404.php'],\n  'acf/imagetext': ['default', 'template-landing-page.php', 'template-homepage.php', '404.php'],\n  'acf/video': ['default', 'template-landing-page.php', 'template-homepage.php', '404.php'],\n  'acf/signpost': ['default', 'template-homepage.php', '404.php', 'template-landing-page.php'],\n  'acf/signpostsection': ['default', 'template-homepage.php', '404.php', 'template-landing-page.php']\n};\nwp.domReady(function () {\n  var restrictor = new _BlockRestrictor__WEBPACK_IMPORTED_MODULE_0__[\"default\"](blockTemplateRestrictions);\n  var templateWhitelister = new _TemplateWhitelister__WEBPACK_IMPORTED_MODULE_1__[\"default\"](blockTemplateRestrictions);\n  restrictor.run();\n  templateWhitelister.run();\n});\n\n/**\n * Automatically add blocks based on page template\n */\nvar _wp$data = wp.data,\n  select = _wp$data.select,\n  subscribe = _wp$data.subscribe;\nvar PageTemplateSwitcher = /*#__PURE__*/function () {\n  function PageTemplateSwitcher() {\n    _classCallCheck(this, PageTemplateSwitcher);\n    this.template = null;\n  }\n  return _createClass(PageTemplateSwitcher, [{\n    key: \"init\",\n    value: function init() {\n      var _this = this;\n      subscribe(function () {\n        var newTemplate = select('core/editor').getEditedPostAttribute('template');\n        if (newTemplate !== undefined && _this.template === null) {\n          _this.template = newTemplate;\n          _this.defaultTemplate();\n          if (_this.template === '' || _this.template === 'default' || _this.template === 'template-landing-page.php') {\n            var introductionBlock = wp.blocks.createBlock('acf/intro');\n            wp.data.dispatch('core/block-editor').insertBlocks(introductionBlock);\n          }\n        }\n        if (newTemplate !== undefined && newTemplate !== _this.template) {\n          _this.template = newTemplate;\n          _this.changeTemplate();\n        }\n      });\n    }\n  }, {\n    key: \"defaultTemplate\",\n    value: function defaultTemplate() {\n      // Set Intro block to be shown by default (prevents hiding of template select)\n\n      wp.domReady(function () {\n        wp.blocks.setDefaultBlockName('acf/intro');\n      });\n    }\n  }, {\n    key: \"changeTemplate\",\n    value: function changeTemplate() {\n      wp.data.dispatch('core/block-editor').resetBlocks([]);\n      if (this.template === '' || this.template === 'default' || this.template === 'template-landing-page.php') {\n        var introductionBlock = wp.blocks.createBlock('acf/intro');\n        wp.data.dispatch('core/block-editor').insertBlocks(introductionBlock);\n      }\n    }\n  }]);\n}();\nnew PageTemplateSwitcher().init();\n\n//# sourceURL=webpack:///./js/main.js?");
